...
const char* password = ".Y{(~GN4[x"; // Replace with your network password
#define DATABASE_URL "https://esp32-xiao-default-rtdb.firebaseio.com/" // Replace with your database URL
#define API_KEY "AIzaSyDp2mWMBtPVpMemsHRR0M3RKOXKiOiW58s" // Replace with your API key
